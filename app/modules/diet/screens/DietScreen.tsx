...
type DietScreenNavigationProp = NativeStackNavigationProp<DietStackParamList, 'DietHome'>;
...
const DietScreen = () => {
  ...
  const renderMealCategory = ({ item }: { item: { id: string; name: string; type: string } }) => (
    <TouchableOpacity 
      style={styles.mealCategoryCard}
      onPress={() => navigation.navigate('MealRecipes', { mealType: item.type })}
    >
